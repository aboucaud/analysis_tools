...
class SizeConfig(Config):
    """Configuration for size vector(s) to be loaded and potentially plotted"""
...
class SizeTool(AnalysisTool):
    ...
    sizes_default = SizeDefaultConfig(
        bulge=SizeConfig(key_size="{band}_bdReB", name_size="Bulge R_eff", has_moments=False),
        disk=SizeConfig(key_size="{band}_bdReD", name_size="Disk R_eff", has_moments=False),
